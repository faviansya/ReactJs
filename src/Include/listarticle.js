  ...
  render() {
    return (
      <div>
        ...
        >
          <img width="300px" src={Berita1} alt="Card image cap" /> <br />
        ...
        <a
          ...
          className="list-group-item list-group-item-action flex-column align-items-start"
        >
          <img width="300px" src={Berita2} alt="Card image cap" /> <br />
          <span className="badge badge-info">New</span>
          <div className=" w-100 justify-content-between">
        ...
        <a
          ...
          className="list-group-item list-group-item-action flex-column align-items-start"
        >
          <img width="300px" src={Berita3} alt="Card image cap" /> <br />
          <span className="badge badge-info">New</span>
          <div className=" w-100 justify-content-between">
          ...
          <p class="mb-1">
            Menurut TIOBE.COM Java Menempati Urutan Pertama Bahasa Pemrograman
            yang Paling Banyak Digunakan diseluruh dunia.
          </p>
          <small className="text-muted">Diposting Oleh: Vian</small>
        </a>
        <a
          ...
          className="list-group-item list-group-item-action flex-column align-items-start"
        >
          <img width="300px" src={Berita4} alt="Card image cap" /> <br />
          <span className="badge badge-info">New</span>
          <div className=" w-100 justify-content-between">
          ...
          <p class="mb-1">
            Belajar di ATA berlokasi di Malang dan sangat menyenangkan, kalian
            mendapatkan fasilitas yang luwar biyasa.
          </p>
          <small className="text-muted">Diposting Oleh: Vian</small>
        </a>
        <a
